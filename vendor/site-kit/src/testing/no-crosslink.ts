import { type Finding, type ScanResult, htmlFiles, readHtml, relativeTo } from "./scan.ts";
...
export const PORTFOLIO_DOMAINS: readonly string[] = [
...
export async function scanNoCrosslink(
  distDir: string,
  ownDomain: string,
): Promise<ScanResult> {
