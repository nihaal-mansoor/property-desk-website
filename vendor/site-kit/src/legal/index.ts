...
export function disclaimer(brand: string): string {
  return (
    `${brand} is an independent property research resource. We are not a licensed ` +
...
export const CONSENT_TEXT =
  "I agree to be contacted about my enquiry and for my details to be shared with " +
...
export function sourcedAsOf(source: string, isoDate: string): string {
...
export function notAffiliated(developer: string): string {
  return (
    `This page is independent editorial content. We are not affiliated with, ` +
